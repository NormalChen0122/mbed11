...
int main(){
   ...
   xbee.write("ATMY 0x137\r\n", 12);

   reply_messange(xbee_reply, "setting MY : 0x137");

   xbee.write("ATDL 0x237\r\n", 12);

   reply_messange(xbee_reply, "setting DL : 0x237");
...
void Acc(Arguments *in, Reply *out) {
   ...
   if(x == 1) {
      sprintf(outbuf, "X: %d, Y: %d, Z: %d", pDataXYZ[0], pDataXYZ[1], pDataXYZ[2]);
      printf("hi X: %d, Y: %d, Z: %d\n\r", pDataXYZ[0], pDataXYZ[1], pDataXYZ[2]);
      out->putData(outbuf);
   }
...
int main(){
   ...
   xbee.write("ATMY 0x237\r\n", 12);
   reply_messange(xbee_reply, "setting MY : 0x237");
   xbee.write("ATDL  0x137\r\n", 12);
   reply_messange(xbee_reply, "setting DL : 0x137");

   xbee.write("ATID 0x1\r\n", 10);
   reply_messange(xbee_reply, "setting PAN ID : 0x1"); // personal area network
...
// void qcall_getACC(Arguments *in, Reply *out)
//{
  //  printf("Hi");
//}
void LEDControl(Arguments *in, Reply *out)
